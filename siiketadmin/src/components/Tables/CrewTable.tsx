                    ...
                    <div>
                        <Breadcrumb className="mb-5">
                            <BreadcrumbList>
                                ...
                                {id != 'null' && <BreadcrumbSeparator />}

                                {id != 'null' && <BreadcrumbItem>
                        ...
                        <DialogContent className="md:max-w-2xl">
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    ...
                                    <DatePicker
                                        initialDate={formData.dob != '' ? new Date(formData.dob) : null}
                                        onDateChange={(value) => {
                                    ...
                                    {formData.identity_proof != '' && formData.address_proof != '' &&
                                        <div className="col-span-2 grid md:grid-cols-2 gap-2">
                                            <div className="space-y-2">
                                                ...
                                                <PDFUploadWithSignedUrl
                                                    ...
                                                    initialUrl={formData.identity_proof_doc != '' ? `${PATH_URL}/${formData.identity_proof_doc}` : ''}
                                                    collection={'organisations'}
                                                    onUploaded={(url, fileName) => handleFormChange('identity_proof_doc', fileName)}
                                                />
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                <PDFUploadWithSignedUrl
                                                    apiEndpoint={`${BASE_URL}/api/files/upload`}
                                                    initialUrl={formData.address_proof_doc != '' ? `${PATH_URL}/${formData.address_proof_doc}` : ''}
                                                    collection={'organisations'}
                                                    onUploaded={(url, fileName) => handleFormChange('address_proof_doc', fileName)}
                                                />
                                            </div>
                                        </div>
                                    }
