        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-4 border-b">
            <Link to="/" className="flex items-center">
              ...
              <h1 className="text-xl font-semibold">SIIKET</h1>
            </Link>
          </div>
            ...
            <nav className="space-y-1">
              ...
              <Link to="/category">
                <MenuItem
                  ...
                  isActive={currentActive == "Category"}
                  title="Category"
                />
              </Link>
              <Link to="/managers">
                <MenuItem
                  ...
                  isActive={currentActive == "Managers"}
                  title="Managers"
                />
              </Link>
              <Link to="/partner">
                <MenuItem
                  icon={<Users2 className="h-5 w-5" />}
                  isActive={currentActive == "Partners"}
                  title="Partners"
                />
              </Link>
             
              <Link to="/crew-members/null">
                <MenuItem
                  icon={<Users2 className="h-5 w-5" />}
              ...
              <Link to="/SecurityCheckerList">
                <MenuItem
                  icon={<Users2 className="h-5 w-5" />}
                  isActive={currentActive == "Security Checkers"}
              ...
              <Link to="/banners">
                <MenuItem
                  ...
                  isActive={currentActive == "Banners"}
                  title="Banners"
                />
              </Link>
               <Link to="/bookings">
                <MenuItem
                  icon={<FileText className="h-5 w-5" />}
                  isActive={currentActive == "Bookings"}
                  title="Bookings"
                />
              </Link>
            </nav>
