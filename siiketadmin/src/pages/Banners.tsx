...
const BannerList = () => {
    ...
    const items = bannerStore((state) => state.items);
    const loading = bannerStore((state) => state.loading);
    const fetchData = bannerStore((state) => state.fetchRecords);
