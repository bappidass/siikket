...
const managerStore = create<Store>((set, get) => ({
    items: [],
    loading: false,
    fetchError: false,
    errorMsg: "",
    fetchRecords: async () => {
        ...
        try {
            ...
            const res = await apiFetch(`/api/administrators/records`, {
                method: "GET",
                headers: {
                    "Authorization": token,
                },
    ...
    saveRecord: async (data: any) => {
        ...
        try {
            ...
            if (!user) throw new Error("Not logged in");
            const token = await user.getIdToken();
            const res = await apiFetch(`/api/administrators/create`, {
                method: "POST",
                headers: {
                    "Authorization": token,
    ...
    updateRecord: async (data: any) => {
        ...
        try {
            ...
            if (!user) throw new Error("Not logged in");
            const token = await user.getIdToken();
            const res = await apiFetch(`/api/administrators/update`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
                    "Content-Type": "application/json"
    ...
    deleteRecord: async (id: string) => {
        ...
        try {
            ...
            if (!user) throw new Error("Not logged in");
            const token = await user.getIdToken();
            const res = await apiFetch(`/api/administrators/record/${id}`, {
                method: "DELETE",
                headers: {
                    "Authorization": token,
                },
