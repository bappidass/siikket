      ...
      <div className="hidden md:flex md:w-3/5 relative overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-indigo-950">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300 max-w-xl">
            Manage your event workforce, monitor registrations, track campaign
            performance, and access real-time business insights from one
            powerful dashboard.
          </p>

          <div className="grid grid-cols-2 gap-4 mt-10 max-w-lg">
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5">
              <Users className="h-7 w-7 text-purple-300 mb-3" />
              <h4 className="font-semibold">Crew Management</h4>
              <p className="text-sm text-slate-400 mt-1">
                Register and manage your event crew.
              </p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5">
              <Briefcase className="h-7 w-7 text-pink-300 mb-3" />
              <h4 className="font-semibold">Partner Dashboard</h4>
              <p className="text-sm text-slate-400 mt-1">
                Access all partner tools from one place.
              </p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5">
              <Megaphone className="h-7 w-7 text-indigo-300 mb-3" />
              <h4 className="font-semibold">Campaign Tracking</h4>
              <p className="text-sm text-slate-400 mt-1">
                Monitor promotions and engagement.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5">
              ...
              <p className="text-sm text-slate-400 mt-1">
                Track approvals, revenue, and growth.
              </p>
            </div>
          </div>
        </div>
